...
def kmeans(sample, centers, tolerance, observe, metric_pointer):
    ...
    package = ccore.kmeans_algorithm(pointer_data, pointer_centers, c_double(tolerance), c_bool(observe), metric_pointer)
